  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="slider-image2-url">İkincil Görsel URL</Label>
            <Input
              id="slider-image2-url"
              value={values.image2_url || ''}
              onChange={(e) => onChange('image2_url', e.target.value)}
              disabled={saving}
              placeholder="https://..."
            />
          </div>
          <div className="space-y-2">
            <Label htmlFor="slider-badge-text">Badge Metni</Label>
            <Input
              id="slider-badge-text"
              value={values.badge_text || ''}
              onChange={(e) => onChange('badge_text', e.target.value)}
              disabled={saving}
              placeholder="Orn: Kaman Cevizi"
            />
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="slider-badge-color">Badge Rengi</Label>
            <Input
              id="slider-badge-color"
              value={values.badge_color || ''}
              onChange={(e) => onChange('badge_color', e.target.value)}
              disabled={saving}
              placeholder="hsl(...) veya #hex"
            />
          </div>
          <div className="space-y-2">
            <Label htmlFor="slider-gradient">Gradient</Label>
            <Input
              id="slider-gradient"
