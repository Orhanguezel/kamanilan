...
export const CustomPageMainColumn: React.FC<Props> = ({
  ...
  const t = useAdminT();
  const moduleOptions = [
    { value: 'about', label: t('admin.customPage.moduleLabels.about') },
    { value: 'quality', label: t('admin.customPage.moduleLabels.quality') },
    { value: 'kvkk', label: t('admin.customPage.moduleLabels.kvkk') },
    { value: 'contract', label: t('admin.customPage.moduleLabels.contract') },
    { value: 'campaign', label: t('admin.customPage.moduleLabels.campaign') },
    { value: 'faq', label: t('admin.customPage.moduleLabels.faq') },
    { value: 'contact', label: t('admin.customPage.moduleLabels.contact') },
    { value: 'blog', label: t('admin.customPage.moduleLabels.blog') },
    { value: 'news', label: t('admin.customPage.moduleLabels.news') },
  ];
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="mb-1 block text-xs text-muted-foreground">{t('admin.customPage.form.moduleKey')}</label>
        <select
