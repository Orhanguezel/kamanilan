/* 97_slider.sql — Kaman İlan (i18n: parent + slider_i18n) */
...
VALUES
(1,UUID(),'/uploads/media/ceviz/kamancevizi.png',NULL,'/uploads/media/ceviz/kamancevizi22.png','Kaman Cevizi','hsl(30 64% 53%)','linear-gradient(130deg, hsl(153, 42%, 12%) 0%, hsl(153, 39%, 28%) 55%, hsl(155, 38%, 38%) 100%)',1,1,1,'2026-02-23 00:00:00.000','2026-02-23 00:00:00.000'),
...
(3,UUID(),'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1600&q=80',NULL,'https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&w=900&q=80','Araç ve Motosiklet','hsl(30 64% 53%)','linear-gradient(130deg, hsl(153, 42%, 9%) 0%, hsl(153, 42%, 18%) 55%, hsl(153, 39%, 30%) 100%)',0,1,3,'2026-02-23 00:00:00.000','2026-02-23 00:00:00.000'),
...
(5,UUID(),'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=1600&q=80',NULL,'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=1600&q=80','Kümes Hayvanları','hsl(30 64% 53%)','linear-gradient(130deg, hsl(153, 45%, 10%) 0%, hsl(153, 35%, 23%) 55%, hsl(153, 31%, 36%) 100%)',0,1,5,'2026-02-23 00:00:00.000','2026-02-23 00:00:00.000'),
...
(1,'tr','Kaman Cevizi: Yeni Hasat İlanları','kaman-cevizi-yeni-hasat-ilanlari','Kaman cevizinde yeni hasat urunlerini dogrudan ureticiden kesfedin.','Kaman cevizi urunleri','Kaman Cevizi Ilanlari','/ilanlar?category=kaman-cevizi'),
(2,'tr','Emlak ve Kira İlanları','emlak-ve-kira-ilanlari','Kaman merkez ve koylerde daire, isyeri, arsa ve tarla ilanlari.','Kaman emlak ilanlari','Emlak Ilanlarini Incele','/ilanlar?category=emlak-kira'),
(3,'tr','Araç ve Motosiklet Pazari','arac-ve-motosiklet-pazari','Otomobil, motosiklet, traktor ve is makinasi ilanlari tek yerde.','Arac ilanlari','Arac Ilanlari','/ilanlar?category=arac-motosiklet'),
(4,'tr','Hayvan ve Tarim Ilanlari','hayvan-ve-tarim-ilanlari','Büyükbaş, kucukbas, tarim ekipmani ve ilgili ilanlara hizli ulasin.','Hayvan ve tarim ilanlari','Hayvan ve Tarim Ilanlari','/ilanlar?category=hayvan-tarim'),
(5,'tr','Kümes Hayvanları Ilanlari','kumes-hayvanlari-ilanlari','Tavuk, hindi, kaz ve diger kumes hayvani ilanlarini goruntuleyin.','Kumes hayvani ilanlari','Kumes Ilanlari','/ilanlar?category=kumes-hayvanlari'),
...
(9,'tr','Genel Satis ve Firsat Ilanlari','genel-satis-ve-firsat-ilanlari','Elektronikten hobi urunlerine kadar farkli kategorilerde firsat ilanlari.','Genel satis ilanlari','Tüm İlanlar','/ilanlar?category=genel-satis'),
...
(12,'tr','Usta ve Hizmet İlanları','usta-ve-hizmet-ilanlari','Elektrikci, tesisatci, boya ve diger usta hizmet ilanlari.','Usta ve hizmet ilanlari','Hizmet İlanları','/ilanlar?category=usta-hizmet');
