...
import { Info, ShieldCheck, Mail, FileText, ArrowRight } from "lucide-react";
import { ROUTES } from "@/config/routes";

export const metadata: Metadata = {
  title: "Kurumsal — Kaman İlan",
  description:
    "Kaman İlan hakkında kurumsal bilgiler, misyonumuz, vizyonumuz ve yasal metinler.",
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            <nav className="mb-8 flex items-center gap-3 text-[10px] font-mono uppercase tracking-[0.2em] text-white opacity-40">
              <Link
                href="/"
                className="hover:text-[hsl(var(--col-saffron))] transition-colors"
              >
                Ana Sayfa
              </Link>
            ...
            <p className="text-[hsl(var(--col-parchment))] opacity-50 text-lg leading-relaxed font-manrope">
              Kaman İlan platformuna dair tüm kurumsal bilgilere, yasal
              metinlere ve iletişim kanallarımıza bu sayfadan ulaşabilirsiniz.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {PAGES.map((page) => (
              ...
              >
                <div
                  className={`h-16 w-16 rounded-2xl ${page.color} flex items-center justify-center mb-8 transition-transform group-hover:scale-110`}
                >
        ...
        <div className="container">
          <div className="relative rounded-[48px] bg-[hsl(var(--col-ivory))] p-10 md:p-24 text-center overflow-hidden border border-black/5 shadow-inner">
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="font-fraunces text-3xl md:text-5xl font-medium text-[hsl(var(--col-ink))] mb-8">
                Yardıma mı ihtiyacınız var?
              </h2>
              <p className="text-[hsl(var(--col-walnut))] opacity-70 mb-12 leading-relaxed">
                Aradığınız bilgiyi bulamadıysanız veya bir sorunuz varsa destek
                ekibimiz size yardımcı olmaktan mutluluk duyacaktır.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <Link
                  href={ROUTES.CONTACT}
                  className="btn-editorial bg-[hsl(var(--col-ink))] text-white px-12"
                >
                  <span>İletişim Formu</span>
                </Link>
                <Link
                  href="mailto:info@kamanilan.com"
                  className="btn-editorial bg-transparent border-black/10 text-[hsl(var(--col-ink))] px-12"
                >
